...
// RadioButton with a visible indicator in both light and dark mode.
// Fusion style draws a nearly invisible circle in dark mode.
RadioButton {
    id: control
    indicator: Rectangle {
        implicitWidth: 18
        ...
        border.color: control.enabled
            ? (control.checked ? palette.highlight : Qt.rgba(palette.text.r, palette.text.g, palette.text.b, 0.5))
