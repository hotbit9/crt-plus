...
Item{
    ...
    QMLTermWidget {
        ...
        function startSession() {
            ...
            if (terminalContainer.shellCommand !== "") {
                ...
                // Default shell parameters for auto login.
    ...
    MouseArea {
        ...
        onPressed: function(mouse) {
            ...
            if ((!kterminal.terminalUsesMouse || mouse.modifiers & Qt.ShiftModifier) && mouse.button == Qt.RightButton) {
                ...
                var coord = correctDistortion(mouse.x, mouse.y);
                // Cmd+click opens file paths and URLs
                var modKey = Qt.MetaModifier
        ...
        onPositionChanged: function(mouse) {
            var coord = correctDistortion(mouse.x, mouse.y);
            // Cmd+hover highlights clickable hotspots
            var modKey = Qt.MetaModifier
    ...
    function hasActiveProcess() { return ksession.hasActiveProcess }
