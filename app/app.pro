...
isEmpty(APP_VERSION): APP_VERSION = "1.0.0"
APP_BUILD = $$system(git -C \"$$PWD/..\" rev-list --count HEAD 2>/dev/null)
isEmpty(APP_BUILD): APP_BUILD = "0"
DEFINES += APP_VERSION=\\\"$$APP_VERSION\\\" APP_BUILD=\\\"$$APP_BUILD\\\"
